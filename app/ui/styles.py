...
QPushButton { background-color:#0d2237; border:1px solid #1f4466; border-radius:12px; padding:9px 13px; color:#f4fbff; font-weight:700; min-height:18px; }
...
QPushButton#SmallGhostButton { background-color: rgba(9,28,44,0.82); border:1px solid #214362; border-radius:11px; padding:7px 12px; color:#d8f5ff; font-size:9.1pt; min-width:78px; }
...
QLabel#SectionMetaLabel { color:#9fbad0; font-size:10pt; line-height: 1.35em; }
QLabel#MutedLabel { color:#94aec2; font-size:9.6pt; }
...
QLabel#EvidenceCardTitle { font-size:10.6pt; font-weight:800; color:#f5fbff; }
QLabel#EvidenceCardMeta { font-size:9.2pt; color:#b0c6d9; }
QLabel#EvidenceCardBadges { font-size:8.9pt; color:#89dfff; }
...
QFrame#EvidenceListCard { background-color:#081621; border:1px solid #10273b; border-radius:16px; }
...
QTabWidget#ReviewTabs QTabBar::tab {
    ...
    padding:10px 16px; margin-right:6px; font-weight:700; min-width:120px;
}
