...
def _normalise_alias_text(value: str) -> str:
    """Normalize landmark aliases and OCR text for conservative full-token matching.

    Supports English, digits, and Arabic while avoiding weak substring matches such
    as matching a short alias inside an unrelated word.
    """
