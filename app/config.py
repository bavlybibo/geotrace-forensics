...
APP_VERSION = '12.10.27'
APP_ORGANIZATION = 'Cyber Forensics Team'
APP_BUILD_CHANNEL = 'Geo Data Expansion + Map AI Calibration Release Gate'
APP_RELEASE_FLAVOR = 'Expanded Offline Geocoder + Arabic/English Geo Aliases + Map AI Calibration'
